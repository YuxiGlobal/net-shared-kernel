using Yuxi.SharedKernel.Specification.Contracts;

namespace Yuxi.SharedKernel.Data.Implementations.Repository
{
    using System;
    ...
    public class Repository<TAgreggate> : IRepositoryAsync<TAgreggate> where TAgreggate : class, ITrackable
    {
        ...
        public Task<IEnumerable<TAgreggate>> ListAll()
        {
            throw new NotImplementedException();
        }

        public Task<IEnumerable<TAgreggate>> ListBySpecification(ISpecification<TAgreggate> specification)
        {
            throw new NotImplementedException();
        }
